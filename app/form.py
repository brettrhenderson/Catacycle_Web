...
class RatesForm(FlaskForm):
    ...
    f_color2 = StringField('f_color2', default='#B467FF')
    f_color3 = StringField('f_color3', default='#014949')
    f_color4 = StringField('f_color4', default='#E58B3C')
    f_color5 = StringField('f_color5', default='#490192')
    f_color6 = StringField('f_color6', default='#28E328')
    f_color7 = StringField('f_color7', default='#6FB7FF')
    f_color8 = StringField('f_color8', default='#920303')
    f_color9 = StringField('f_color9', default='#019292')
    f_color10 = StringField('f_color10', default='#924A02')
